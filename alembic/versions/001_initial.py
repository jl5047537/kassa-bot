...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('level', sa.Integer(), nullable=False, default=5),
        sa.Column('ton_wallet_address', sa.String(), nullable=True),
        sa.Column('wallet_status', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_table(
        ...
        sa.Column('wallet_connected', sa.Boolean(), nullable=False, default=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
